...
set(CMAKE_MUSA_COMPILER /usr/local/musa/bin/mcc CACHE FILEPATH "MUSA C compiler")
...
set(CMAKE_MUSA_FLAGS "${CMAKE_C_FLAGS} -Wp,-D_GLIBCXX_ASSERTIONS" CACHE STRING "MUSA C compiler flags")
...
set(CMAKE_MUSA_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG}" CACHE STRING "MUSA C compiler flags for debug mode")
...
set(CMAKE_MUSA_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE}" CACHE STRING "MUSA C compiler flags for release mode")
set(CMAKE_INTERPROCEDURAL_OPTIMIZATION_RELEASE False CACHE BOOL "Enable interprocedural optimization for release mode")
...
set(CMAKE_MUSA_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO}" CACHE STRING "MUSA C compiler flags for release with debug info mode")
...
set(CMAKE_MUSA_FLAGS_MINSIZEREL "${CMAKE_C_FLAGS_MINSIZEREL}" CACHE STRING "MUSA C compiler flags for minimum size release mode")
set(CMAKE_INTERPROCEDURAL_OPTIMIZATION_MINSIZEREL False CACHE BOOL "Enable interprocedural optimization for minimum size release mode")
